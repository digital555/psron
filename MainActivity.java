...
public class MainActivity extends Activity implements SurfaceTextureListener,OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        odswierzanie = new Thread(new MyRun());
        odswierzanie.start();
    ...
    private void initFlightController() {
        ...
        try {
            sema.acquire();
            trollSocket.dataToSend = String.valueOf(droneLocationLat + " " + droneLocationLng);
            showTest(trollSocket.dataString + " " + trollSocket.dataToSend);

            //Toast.makeText(getApplicationContext(),String.valueOf(droneLocationLat + " " + droneLocationLng) , Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
        ...
        //test.setText(String.valueOf(droneLocationLat + " " + droneLocationLng));



        /*try {
            Socket soket = new Socket("10.3.2.75", 1234);
            OutputStream out = soket.getOutputStream();
            PrintWriter output = new PrintWriter(out);

            test.setText("Sending Data to PC");
            output.println(String.valueOf(droneLocationLat + " " + droneLocationLng));
            out.flush();
            out.close();
            test.setText("Data sent to PC");

            soket.close();
            test.setText("Socket closed" + String.valueOf(droneLocationLat + " " + droneLocationLng));
        } catch (IOException e){
        ...
        mFlightController.sendDataToOnboardSDKDevice(data,
                new DJICommonCallbacks.DJICompletionCallback() {
                    ...
                    public void onResult(DJIError pError) {
                        //Toast.makeText(getApplicationContext(), pError.toString(), Toast.LENGTH_LONG).show();
                    }
                });
    }
    ...
    public void showTest(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
               test.setText(msg);
            }
